...
(defun config-from-env ()
  "Create a config struct from environment variables.
   Environment variables:
     SQUASH_DATA_DIR     — data directory (preferred, default /data)
     SQUASH_DATA         — legacy data directory alias
  ...
  (let* ((legacy-data (env-or "SQUASH_DATA" "/data"))
         (data-dir (env-or "SQUASH_DATA_DIR" legacy-data)))
    (make-config
   :data-dir       data-dir
