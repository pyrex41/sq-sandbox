...
3. **Phase 3: Sandbox create + destroy + exec** — Full lifecycle. Clack/Lack HTTP stack (Woo backend) with health endpoint and create/exec/destroy routes. This is the proof-of-concept milestone.
