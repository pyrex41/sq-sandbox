...
pub fn router(
    ...
    let api_routes = Router::new()
        ...
        .route("/cgi-bin/api/sandboxes/{id}/fork", post(handlers::fork_sandbox))
        .route("/cgi-bin/api/sandboxes/{id}/diff", get(handlers::diff_snapshots))
        .route("/cgi-bin/api/sandboxes/{id}/history", get(handlers::snapshot_history))
